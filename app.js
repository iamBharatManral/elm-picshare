...
var $author$project$Picshare$viewComments = function (photo) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('comments-info')
			]),
		_List_fromArray(
			[
...
var $author$project$Picshare$viewDetailedPhoto = function (photo) {
	var likedClass = photo.liked ? 'fa-heart' : 'fa-heart-o';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class(likedClass),
...
var $author$project$Picshare$viewFeedPlaceholder = function (_v0) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('feed-placeholder')
			]),
		_List_fromArray(
			[
...
var $author$project$Picshare$viewFeed = function (maybeFeed) {
	if (maybeFeed.$ === 'Just') {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('feeds')
				]),
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('feed-placeholder-list')
				]),
			A2(
				$elm$core$List$map,
				$author$project$Picshare$viewFeedPlaceholder,
				_List_fromArray(
					[1, 2, 3])));
	}
};
